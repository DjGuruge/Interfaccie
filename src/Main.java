public class Main {
    public static void main(String[] args) {
        Student studente = new Student("Vincent", "Guruge", 7);
    }

    public static Rankable highRankable(Rankable[] array) {
        Rankable best = null;
        for (Rankable i : array) {
            if (best == null || current.getRank() > best.getRank()) {
                current = best;
                return best;
            }
        }
...
/*Implementare una classe Student con nome, cognome e
media dei voti.
